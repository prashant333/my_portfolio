export const navItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "Delivering Tailored Solutions Through Clear and Consistent Communication",
      description: "",
    ...
    },
    {
      id: 3,
      title: "My tech stack",
      description: "I constantly try to update and improve",
      className: "lg:col-span-2 md:col-span-3 md:row-span-2",
      imgClassName: "",
    ...
    {
      id: 5,
      title: "Currently building a scalable solution for EV fleet industry of all scale.",
    ...
    {
      id: 6,
      title: "Click below to reach out to me!",
      description: "",
      className: "lg:col-span-2 md:col-span-3 md:row-span-1",
      imgClassName: "",
