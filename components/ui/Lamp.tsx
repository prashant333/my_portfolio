  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-0 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight"
      >
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <div className="absolute top-1/2 h-28 w-full translate-y-12 scale-x-150 bg-slate-950 blur-2xl"></div>
